    ...
    return (
        ...
        >
            ...
            <style>{`
                ...
                .input-group label { font-size: 0.85rem; font-weight: 600; color: var(--color-text-dark); }
                ...
                .input-wrapper input:focus { border-color: var(--decoud-blue); box-shadow: 0 0 0 4px rgba(27, 54, 93, 0.05); }

                .auth-submit-btn { background: var(--decoud-blue); color: white; border: none; padding: 16px; border-radius: 10px; font-weight: 800; font-size: 0.9rem; cursor: pointer; transition: all 0.3s; margin-top: 10px; letter-spacing: 1px; }
                .auth-submit-btn:hover { background: var(--decoud-blue-dark); transform: translateY(-2px); box-shadow: 0 10px 20px rgba(0, 0, 0, 0.2); }
                ...
                .auth-footer-text { text-align: center; font-size: 0.9rem; color: var(--color-text-dark); margin-top: 10px; opacity: 0.8; }
                .auth-footer-text a { color: var(--decoud-blue); font-weight: 700; text-decoration: none; }
